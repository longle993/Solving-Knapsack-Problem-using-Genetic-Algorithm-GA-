...
class Ui_UIKnapsack(object):
    ...
    def setQuantity(self):
        ...
        max_weight = self.spinTotalWeight.value()
        if(quantity > 1):
            if(max_weight < 12):
                msg_box = QtWidgets.QMessageBox()
                msg_box.setIcon(QtWidgets.QMessageBox.Icon.Information)
                msg_box.setText("Your Max Weight must be greater than 12")
                msg_box.setWindowTitle("Notice")
                msg_box.exec()
            else:           
...
"}")
        ...
        self.grNumberItems.setGeometry(QtCore.QRect(150, 80, 561, 321))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(14)
        font.setBold(True)
...
"")
        ...
        self.btnNextStep3.setGeometry(QtCore.QRect(290, 240, 131, 51))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        font.setBold(True)
...
"}")
        ...
        self.btnBackStep1.setGeometry(QtCore.QRect(130, 240, 131, 51))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        font.setBold(True)
...
"}")
        ...
        self.spinQuantity.setGeometry(QtCore.QRect(290, 80, 81, 41))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        self.spinQuantity.setFont(font)
        self.spinQuantity.setObjectName("spinQuantity")
        self.label = QtWidgets.QLabel(parent=self.grNumberItems)
        self.label.setGeometry(QtCore.QRect(180, 90, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(parent=self.grNumberItems)
        ...
        self.spinTotalWeight = QtWidgets.QSpinBox(parent=self.grNumberItems)
        self.spinTotalWeight.setGeometry(QtCore.QRect(290, 160, 81, 41))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        self.spinTotalWeight.setFont(font)
        self.spinTotalWeight.setObjectName("spinTotalWeight")
        ...
        self.grCreateItemsAuto.setVisible(False)
        #Set Default Value
        self.spinQuantity.setValue(2)
        self.spinTotalWeight.setValue(12)
    ...
    def retranslateUi(self, UIKnapsack):
        ...
        self.grNumberItems.setTitle(_translate("UIKnapsack", "Step 2: Define some parameters"))
        self.btnNextStep3.setText(_translate("UIKnapsack", "Next"))
        self.btnBackStep1.setText(_translate("UIKnapsack", "Back"))
        self.label.setText(_translate("UIKnapsack", "Quantity:"))
        self.label_2.setText(_translate("UIKnapsack", "Weight:"))
